...
namespace protoytpe.Matrices
{
    public class MatrixDivision:IMatrixDivision
    {
        public int[,] Matrixdivision()
        {
            //Setting dimensions of both matrix
            //int dimension1;Console.WriteLine("Enter the amount of columns in your first")
